...
namespace Gamelogic.Extensions
{
	...
	public static class ColorExtensions
	{
		...
		public static Color Max(this Color color, Color reference)
		{
			return new Color(Mathf.Max(color.r, reference.r),
				Mathf.Max(color.g, reference.g),
				Mathf.Max(color.b, reference.b),
				Mathf.Max(color.a, reference.a));
		}
