...
namespace Gamelogic.Extensions
{
	...
	public class GLMonoBehaviour : MonoBehaviour, IWorldPosition
	{
		[HideInInspector]
	...
	public static class MonoBehaviourExtensions
	{
		...
		public static T GetComponentAnyway<T>(this GameObject obj) where T : Component
		{
		...
		public static T GetComponentAlways<T>(this Component thisComponent) where T : Component
		{
			var result = thisComponent.GetComponent<T>();
			if (result == null)
				result = thisComponent.gameObject.AddComponent<T>();
