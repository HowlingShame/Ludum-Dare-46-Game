...
[CustomPropertyDrawer(typeof(NormalAttribute))]
		...
		switch (property.propertyType)
		{
			case SerializedPropertyType.Vector2:
			{
				if (property.vector2Value == default)
					property.vector2Value = (attribute as NormalAttribute).m_DefaultValue;
			...
			case SerializedPropertyType.Vector3:
			{
				if (property.vector3Value == default)
					property.vector3Value = (attribute as NormalAttribute).m_DefaultValue;
			...
			case SerializedPropertyType.Vector4:
			{
				if (property.vector4Value == default)
					property.vector4Value = (attribute as NormalAttribute).m_DefaultValue;
